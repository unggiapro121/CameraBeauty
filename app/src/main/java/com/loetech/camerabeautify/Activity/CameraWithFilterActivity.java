...
import static com.loetech.camerabeautify.Activity.CameraWithFilterActivity.FACEEFFECT.BIGEYES;
import static com.loetech.camerabeautify.Activity.CameraWithFilterActivity.FACEEFFECT.WHITE;
...
//Sound ON & OFF
    ...
    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.img_main_timer) {
                onTouchLayout.setVisibility(View.GONE);
                llt_layout_more.setVisibility(View.GONE);
                Dev_Info_layout.setVisibility(View.GONE);
                About_layout.setVisibility(View.GONE);
...
//                                startcount();
        ...
        } else if (v.getId() == R.id.btn_sticker) {
        ...
        } else if (v.getId() == R.id.llt_main_smooth) {
        ...
        } else if (v.getId() == R.id.llt_main_white) {
        ...
        } else if (v.getId() == R.id.llt_main_slimming) {
        ...
        } else if (v.getId() == R.id.llt_main_big_eye) {
